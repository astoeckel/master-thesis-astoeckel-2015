...
% Addition by Andreas Stöckel: Use "Palatino" font
graphics_toolkit('gnuplot');
set(0, 'DefaultTextFontName', 'URW Palladio L')
...
% Save result as PDF (addition by Andreas Stöckel)
w = 11.8 / 2.4;
h = 15 / 2.4;
set(gcf, 'PaperPosition', [0 0 w h]);
set(gcf, 'PaperSize', [w h]);
saveas(gcf, 'izhikevich_whichmod_figure1.pdf', 'pdf')
